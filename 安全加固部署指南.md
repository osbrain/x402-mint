...
async function checkBalance() {
  ...
  // 告警阈值：低于0.01 ETH
  if (balanceEth < 0.01) {
    console.error("⚠️ ALERT: Distributor balance too low!");
    // 发送告警邮件/Slack通知
...
# 检查 frontend 域名是否匹配
# backend/.env
FRONTEND_URL="http://localhost:3000"  # ← 确保匹配
